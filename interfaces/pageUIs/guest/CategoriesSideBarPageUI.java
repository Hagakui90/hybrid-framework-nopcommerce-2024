...
public class CategoriesSideBarPageUI {
	...
	public static final String PRODUCT_TITLE_LIST_TEXT = "XPATH=//div[@class='products-container']//h2//a";
	...
	public static final String PAGE_LINK_BY_NUMBER = "XPATH=//div[@class='pager']//a[text()='%s']";
