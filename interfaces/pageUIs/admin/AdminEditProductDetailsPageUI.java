...
public class AdminEditProductDetailsPageUI {
	...
	public static final String NEXT_BUTTON_EACH_CARD_BY_NUMBER_PAGE = "XPATH=//p[contains(text(),'%s')]/parent::div//a[text()='%s']//parent::li/following-sibling::li";
	public static final String ACTIVE_PAGE_LINK_EACH_CARD = "XPATH=//p[contains(text(),'%s')]/parent::div//li[contains(@class,'active')]/a";
	public static final String NAME_OF_PRODUCT_TEXTFIELD = "css=input#Name";
}
