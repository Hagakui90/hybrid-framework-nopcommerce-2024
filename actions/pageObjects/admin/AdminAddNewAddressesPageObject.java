...
public class AdminAddNewAddressesPageObject extends BasePage{
	...
	public boolean verifyAddedNewAddress(Address address) {
		...
		System.out.println(getValueAttributeInfo("CountryId"));
		System.out.println(getValueAttributeInfo("StateProvinceId"));
		System.out.println(getValueAttributeInfo("City"));
